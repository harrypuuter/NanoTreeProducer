...
def getJetCalibrationMC(year,redoJEC=True):
    """Get JME calibrator for MC of a given year."""
    if year==2016:
      jetmetUncertainties2016 = lambda: jetmetUncertaintiesProducer('2016',"Summer16_07Aug2017_V11_MC",['Total'],redoJEC=redoJEC)
      return jetmetUncertainties2016
      #return jetmetUncertainties.jetmetUncertainties2016
    elif year==2017:
      jetmetUncertainties2017 = lambda: jetmetUncertaintiesProducer("2017", "Fall17_17Nov2017_V32_MC",['Total'],redoJEC=redoJEC)
      return jetmetUncertainties2017
      #return jetmetUncertainties.jetmetUncertainties2017
    else:
      jetmetUncertainties2018 = lambda: jetmetUncertaintiesProducer("2018", "Autumn18_V8_MC",['Total'],redoJEC=redoJEC)
