...
maxEvts   = int(1e3)
postfix   = '_skimmed'
presel    = "Muon_pt[0] > 50 && Jet_pt[0] > 50"
...
#p = PostProcessor(outdir, infiles, None, "keep_and_drop_jets.txt", noOut=False, modules=[ExampleAnalysis()], provenance=False, postfix=postfix, maxEntries=maxEvts)
p.run()
