...
class TreeProducerTauTau(TreeProducerCommon):
    ...
    def __init__(self, name, dataType, **kwargs):
        ...
        self.addBranch('rawDeepTau2017v2VSe_1',      'f')
        self.addBranch('rawDeepTau2017v2VSmu_1',     'f')
        self.addBranch('rawDeepTau2017v2VSjet_1',    'f')
        ...
        self.addBranch('idDeepTau2017v2VSe_1',       'i')
        self.addBranch('idDeepTau2017v2VSmu_1',      'i')
        self.addBranch('idDeepTau2017v2VSjet_1',     'i')
